...
while True:
    ...
    show_detected_img(frame, predicted_obj, box_location, class_id, conf_value, org_width/YOLO_IMAGE_SIZE, org_height/YOLO_IMAGE_SIZE)
    counter = 'Number of Cars: ' + str(int(count))
    cv.putText(frame, counter, (10,15), cv.FONT_HERSHEY_COMPLEX_SMALL, 1, (255,0,255), 1)
